        ...
        <div className="bg-white rounded-2xl shadow-xl h-full flex items-center justify-center border border-blue-100">
          <div className="text-center p-8">
            ...
            <p className="text-slate-600 mb-6 max-w-md">
              This is where your Flowise chatbot will be embedded. Replace this placeholder with your Flowise embed code.
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-left max-w-2xl mx-auto">
              <p className="text-sm font-mono text-blue-900 mb-2">
                To embed your Flowise chatbot:
              </p>
              <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
                <li>Get your chatbot embed code from Flowise</li>
